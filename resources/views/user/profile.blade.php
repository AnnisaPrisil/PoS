...
<body>
    <nav class="navbar">
        <ul>
            ...
            <li><a href="{{ route('user.profile', ['id' => 1, 'name' => 'AnnisaP']) }}"><i class="fas fa-user"></i> User</a></li>
        </ul>
    </nav>
    ...
    <main>
        <p>Selamat Datang!</p> <br>Annisa Prissilya/5 SIB 3A </br> <br>2241760099</br ><br>Berikut adalah informasi profil Anda</br>
    </main>
    <script>
